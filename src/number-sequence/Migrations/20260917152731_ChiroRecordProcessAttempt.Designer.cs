...
namespace number_sequence.Migrations
{
    ...
    [Migration("20260917152731_ChiroRecordProcessAttempt")]
    partial class ChiroRecordProcessAttempt
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.HasSequence("ChiroEmailBatchIds")
                .StartsAt(500L);

            modelBuilder.HasSequence("CountEventIds");
            ...
            modelBuilder.HasSequence("InvoicePaymentIds");

            modelBuilder.HasSequence("StatementIds");
            ...
            modelBuilder.Entity("TcpWtf.NumberSequence.Contracts.Count", b =>
                {
                    ...
                    b.Property<bool>("OverflowDropsOldestEvents")
                        .HasColumnType("bit");
            ...
            modelBuilder.Entity("TcpWtf.NumberSequence.Contracts.CountEvent", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
            ...
            modelBuilder.Entity("TcpWtf.NumberSequence.Contracts.Ledger.InvoiceLineDefault", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bigint")
            ...
            modelBuilder.Entity("TcpWtf.NumberSequence.Contracts.Ledger.Statement", b =>
                {
                    ...
                    b.Property<bool>("SearchByDueDate")
                        .HasColumnType("bit");
            ...
            modelBuilder.Entity("number_sequence.Models.ChiroRecord", b =>
                {
                    b.Property<string>("RowId")
                        .HasMaxLength(64)
                        .HasColumnType("nvarchar(64)");

                    b.Property<DateTimeOffset>("DataEnteredAt")
                        .HasColumnType("datetimeoffset");
            ...
            modelBuilder.Entity("TcpWtf.NumberSequence.Contracts.CountEvent", b =>
                {
                    b.HasOne("TcpWtf.NumberSequence.Contracts.Count", "Count")
                        .WithMany("Events")
                        .HasForeignKey("Account", "CountName")
            ...
            modelBuilder.Entity("TcpWtf.NumberSequence.Contracts.Ledger.BusinessLogo", b =>
                {
                    b.HasOne("TcpWtf.NumberSequence.Contracts.Ledger.Business", "Business")
                        .WithOne("Logo")
                        .HasForeignKey("TcpWtf.NumberSequence.Contracts.Ledger.BusinessLogo", "BusinessId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
            ...
            modelBuilder.Entity("TcpWtf.NumberSequence.Contracts.Ledger.Invoice", b =>
                {
                    ...
                    b.HasOne("TcpWtf.NumberSequence.Contracts.Ledger.Customer", "Customer")
                        .WithMany("Invoices")
                        .HasForeignKey("CustomerId")
                        .OnDelete(DeleteBehavior.Restrict)
                        .IsRequired();

                    b.HasOne("TcpWtf.NumberSequence.Contracts.Ledger.Statement", null)
                        .WithMany("Invoices")
            ...
            modelBuilder.Entity("TcpWtf.NumberSequence.Contracts.Ledger.InvoiceLine", b =>
                {
                    b.HasOne("TcpWtf.NumberSequence.Contracts.Ledger.Invoice", "Invoice")
                        .WithMany("Lines")
