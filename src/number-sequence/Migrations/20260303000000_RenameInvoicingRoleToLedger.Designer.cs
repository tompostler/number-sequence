...
namespace number_sequence.Migrations
{
    ...
    [Migration("20260303000000_RenameInvoicingRoleToLedger")]
    partial class RenameInvoicingRoleToLedger
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("TcpWtf.NumberSequence.Contracts.Invoicing.InvoiceBusinessLogo", b =>
                {
                    b.Property<long>("BusinessId")
                        .HasColumnType("bigint");
            ...
            modelBuilder.Entity("TcpWtf.NumberSequence.Contracts.Invoicing.Statement", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bigint")
            ...
            modelBuilder.Entity("TcpWtf.NumberSequence.Contracts.Invoicing.Invoice", b =>
                {
                    ...
                    b.HasOne("TcpWtf.NumberSequence.Contracts.Invoicing.Statement", null)
                        .WithMany("Invoices")
            ...
            modelBuilder.Entity("TcpWtf.NumberSequence.Contracts.Invoicing.InvoiceBusinessLogo", b =>
                {
                    b.HasOne("TcpWtf.NumberSequence.Contracts.Invoicing.InvoiceBusiness", "Business")
                        .WithOne("Logo")
                        .HasForeignKey("TcpWtf.NumberSequence.Contracts.Invoicing.InvoiceBusinessLogo", "BusinessId")
