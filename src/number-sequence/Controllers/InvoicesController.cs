...
namespace number_sequence.Controllers
{
    ...
    public sealed class InvoicesController : ControllerBase
    {
        ...
        public async Task<IActionResult> CreateBusinessLogoAsync(long id, [FromBody] InvoiceBusinessLogo logo, CancellationToken cancellationToken)
        {
            logo.BusinessId = id;
        ...
        public async Task<IActionResult> UpdateBusinessLogoAsync(long id, [FromBody] InvoiceBusinessLogo logo, CancellationToken cancellationToken)
        {
            string[] allowedContentTypes = ["image/gif", "image/jpeg", "image/png", "image/webp"];
            if (!allowedContentTypes.Contains(logo.ContentType))
            {
            ...
            InvoiceBusinessLogo logoRecord = await nsContext.InvoiceBusinessLogos
        ...
        public async Task<IActionResult> GetBusinessLogoAsync(long id, CancellationToken cancellationToken)
        {
            ...
            InvoiceBusinessLogo logo = await nsContext.InvoiceBusinessLogos
                .SingleOrDefaultAsync(x => x.BusinessId == id, cancellationToken);
            if (logo == default)
            {
                return this.NotFound();
        ...
        public async Task<IActionResult> CreateStatementAsync([FromBody] Statement statement, CancellationToken cancellationToken)
        {
            ...
            statement.Business = invoiceBusiness;
            ...
            statement.Customer = invoiceCustomer;
